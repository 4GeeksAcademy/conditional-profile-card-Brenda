...
function render(variables = {}) {
  ...
  let github = variables.github
    ? `<a href="https://github.com/${variables.github}"><i class="fab fa-github fa-2x"></i></a>`
    : "";
  let linkedin = variables.linkedin
    ? `<a href="https://linkedin.com/in/${variables.linkedin}"><i class="fab fa-linkedin fa-2x"></i></a>`
    : "";
  let instagram = variables.instagram
    ? `<a href="https://instagram.com/${variables.instagram}"><i class="fab fa-instagram fa-2x"></i></a>`
    : "";
